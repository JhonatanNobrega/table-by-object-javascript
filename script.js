...
let obj = {
  ...
  cabecalho: [
    ...
    [
      {input: 'Nome', float: 'true'},
      {input: 'Sobrenome', float: 'true'},
    ]
  ]
}

const tabelaTs = new Tabela({ obj, elemento: divTabela });
// const arrayTabelaTs = tabelaTs.getInputsCabecalho();
...
//   let inputs = tabelaTs.criarCorpo({ prefix: 'ts1', corpo });
//   console.log(inputs);
